...
Swarm.prototype._onAnnounceStarted = async function (params, peer, id) {
  if (peer) {
...
Swarm.prototype._onAnnounceCompleted = async function (params, peer, id) {
  if (!peer) {
...
Swarm.prototype._onAnnounceUpdate = async function (params, peer, id) {
  if (!peer) {
